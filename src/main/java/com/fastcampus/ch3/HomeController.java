...
public class HomeController {
	@Autowired
	WebApplicationContext servletAC; // Servlet AC는 주입받을 수 있음.
	...
	public String home(Locale locale, HttpServletRequest request, Model model) {
		...
		WebApplicationContext rootAC = WebApplicationContextUtils.getWebApplicationContext(sc); //25~26 Root AC를 가져오는 방법
